...
import { listarPosts, postar, uploadImagem, atualizarNovoPost } from "../controllers/postController.js"; // Importa as funções controladoras para lidar com a lógica dos posts
...
const routes = (app) => {
  ...
  app.post("/posts", postar); // Chama a função controladora para criação de posts
